...
public class Advent22 {
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			reader = new BufferedReader(new InputStreamReader(Advent22.class.getResourceAsStream("inputs.txt")));
		...
		System.out.println(coordinates[0] + " " + coordinates[1] + " " + player.getDirection());
		...
		System.out.println(player.moves.size());
		int max = 880;
		int c=0;
		...
		PrintStream out = new PrintStream("sol1.txt");
